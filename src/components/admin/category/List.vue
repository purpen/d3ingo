            ...
            <el-table-column
              ...
              label="操作">
                <template slot-scope="scope">
                  ...
                  <p>
                    <router-link :to="{name: 'adminCategorySubmit', query: {id: scope.row.id}}">编辑</router-link>
...
export default {
  ...
  methods: {
    ...
    loadList() {
      ...
      self.isLoading = true
      self.$http.get(api.adminCategoryList, {params: {page: self.query.page, per_page: self.query.pageSize, sort: self.query.sort, type: self.query.type}})
      .then (function(response) {
