...
export default {
  ...
  methods: {
    ...
    loadList() {
      ...
      self.isLoading = true
      self.$http.get(api.adminAwardsList, {params: {page: self.query.page, per_page: self.query.pageSize, sort: self.query.sort, type: self.query.type, status: self.query.status}})
      .then (function(response) {
