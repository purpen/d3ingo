...
export default {
  ...
  data() {
    return {
      ...
      createdTime: '',
      updateTime: '',
      sourceArr: [...typeData.PROMOTE_SOURCE],
      sonSourceValue: '',
      sourceValue: '',
      sonSource: [],
      userStatus: [ // 客户状态
...
.all-choose-design .design-li {
  padding-bottom: 0;
  border: 1px solid rgba(216,216,216,1);
  border-radius: 4px;
}
.all-choose-design .design-li .flex-column > span {
  padding-bottom: 15px;
}
.footer-img {
  width: 16px;
...
.custom-userinfo-dialog .el-dialog__footer .dialog-footer {
  justify-content: space-between;
}
.custom-userinfo-dialog .el-button {
  height: 40px;
  line-height: 40px;
}
.custom-userinfo-dialog .el-button--default {
  font-size: 14px;
  font-family: PingFangSC-Regular;
  font-weight: 400;
  color: rgba(153,153,153,1);
}
.custom-userinfo-dialog .el-button--primary {
  font-size: 14px;
  font-family: PingFangSC-Regular;
  font-weight: 400;
  color: rgba(255,255,255,1);
}
.custom-userinfo-dialog .el-dialog__title {
  font-size: 16px;
  font-family: PingFangSC-Medium;
  font-weight: 500;
