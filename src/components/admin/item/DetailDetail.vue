  ...
  <div>
    ...
    <div class="flex">
      <div class="flex-column-center flex-1 pad-top-10">
        ...
        <div class="order-date pad-top-5">2019-03-23 14:21:02</div>
      </div>
      <div class="flex-column-center flex-1 pad-top-10">
        <div class="order-title">首付款</div>
        <div class="order-date pad-top-5">2019-03-23 14:21:02</div>
        <div class="order-money pad-top-5">￥116,000.00</div>
      </div>
      <div class="flex-column-center flex-1 pad-top-10">
    ...
    <div class="flex pad-top-16">
      ...
      <div class="grey-text">杭州瑞德设计股份有限公司</div>
    </div>
    <div class="flex pad-top-16">
      <div class="grey-title">合同金额</div>
      <div class="grey-text">￥326,000.00</div>
    </div>
    <div class="flex pad-top-16">
      <div class="grey-title">签约日期</div>
      <div class="grey-text">2019年03月23日</div>
    </div>
