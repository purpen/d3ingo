      ...
      <el-col :span="24">
        <div class="right-content">
          <div class="content-box">
            ...
            <p>甲方在“京东云艺火”平台（以下简称“平台”）上发布设计需求项目（以下简称“项目”）；</p>
            <p>乙方通过平台承接项目，并有权为履行本合同之目的，委托第三方设计服务商履行本合同项下全部或部分权利义务；</p>
            <p>甲、乙双方一致同意按照本合同的约定，由乙方向甲方提供项目所包含的设计服务成果交付等相应支持，为甲方实现设计需求。</p>
            <p>关于双方合作的相关细节约定如下：</p>
            <p class="title mar-t-40 font-size-18">一、项目内容和项目费用</p>
            ...
            <p>&nbsp;</p>
            <p>
              6、在合同签订后，对于项目涉及内容略有调整的情况，双方应友好协商解决。</p>
            <p>&nbsp;</p>

            <p class="title mar-t-40 font-size-18">六、知识产权</p>
            <p>
              1、对因本合同产生的甲方选定方案，在甲方按照本合同约定完成相关的付款义务后，其全部知识产权归甲方所有。乙方保留设计者署名权。除甲方选定的方案外，落选方案的全部知识产权仍归乙方平台内设计服务商所有。若甲方需要享有其他设计方案的知识产权时，需与乙方协商买断该等知识产权的相关事宜；</p>
            <p>&nbsp;</p>
            ...
            <p>&nbsp;</p>
            <p>5、本合同保密条款不因双方合作的终止、本合同的解除而无效。</p>

            <p class="title mar-t-40 font-size-18">十一、其它</p>
            <p>1、本合同如有未尽事宜，须经双方协商补充规定，补充规定与合同具有同等效力。</p>
            <p>&nbsp;</p>
            <p>2、本合同一式两份，甲乙方各持一份，自双方在平台确认之日起生效，具同等法律效力。</p>
