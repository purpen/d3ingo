    ...
    <div class="large-background">
          ...
          <div class="scene-cloud">
            ...
            <div class="scene-right">
              <div class="span-right-text">
                <span class="span-text">与会嘉宾签到，参观碧桂园汽车小镇展厅</span>
              </div>
              ...
              <div class="button-right">
                <div class="span-button2">
                  <span class="button-text">洽谈区</span>
                </div>
                <div class="text4">
                  <span class="span-text">项目供方进入洽谈区</span>
                </div>
                <div class="text5-right">
                  <span class="span-text">双方洽谈</span>
                </div>
                <div class="text6-right">
                  <span class="span-text">双方洽谈</span>
                </div>
              </div>
            </div>
      ...
      <div class="online">
        ...
        <div class="online-side">
          <span class="content-text">需求公司</span>
        </div>
        <div class="side">
      ...
      <div class="review">
        ...
        <div class="cloud-count">
          <div class="number-cloud">
            ...
            <span class="number-text">参会人数</span>
          </div>
          <div class="enterprise-cloud">
            <div class="enterprise">
            </div>
            <span class="enterprise-text">参会企业</span>
          </div>
          ...
          <div class="project-cloud">
            ...
            <span class="project-text">展示项目</span>
          </div>
          <div class="amount-cloud">
            <div class="amount">
            </div>
            <span class="amount-text">总成交额</span>
          </div>
        </div>
      </div>
