        ...
        <el-col :span="24">
          <div class="h-right-content  bg-f">
            ...
            <div class="content-box">
              ...
              <p>不得利用{{custom.info}}平台网络服务系统进行任何可能对互联网正常运转造成不利影响的行为；</p>
              ...
              <p>&nbsp;</p>
              <p>严肃认真对待您在{{custom.info}}平台上的账号，保证提供的所有信息真实、准确，如有变更，及时在系统中更改；</p>
              <p>{{custom.info}}平台账户的所有内容与信息都与您的权利与义务直接相关，请您妥善保管，勿转借他人；若因黑客行为、第三方恶意攻击、用户的保管疏忽导致用户损失的，平台不承担任何责任；</p>

              <h3>2.关于平台</h3>
              <p>{{custom.info}}平台同意按照本协议规定发布的操作规则提供基于互联网以及移动网相关服务（以下称"网络服务"），为获得网络服务，平台所有用户应当同意本协议的全部条款并按照页面上的提示完成全部的注册程序。用户在使用过程中完成全部流程即表示完全接受本协议项下的全部条款。</p>
              <p></p>
              ...
              <h3>4.隐私保护</h3>
              <p>{{custom.info}}平台承诺不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在平台的非公开内容；</p>
              <p>为保证平台正常运转，平台会对用户提交的资料进行审核，如发现不妥之处，有权要求用户更改或完善；</p>
              <p>若用户在平台行为涉及违法违规，平台有权配合相关法律机构进行调查；</p>
              <p>有以下情况时，{{custom.info}}平台不严格遵守对用户的隐私保护条款：</p>
              <p>事先获得用户的明确授权；</p>
              ...
              <p>用户间的侵权行为，{{custom.info}}平台可以帮助协调解决，但不承担任何法律责任；</p>

              <h3>6.举报机制</h3>
              <p>若您在平台使用过程中发现任何违法、违规或侵害您权益的现象，请及时与{{custom.info}}平台联络，寻求法律手段处理不当现象。</p>
              <p style="padding-bottom:30px">{{custom.info}}平台对以上协议内容拥有最终解释权。</p>
