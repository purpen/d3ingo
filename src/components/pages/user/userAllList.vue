<template>
    ...
    <div class="container">
            ...
            <el-table
              ...
              width="180"
                ...
                <div slot-scope="userphoto" class="userphoto">
                  ...
                  <span @click="touchMsg(userphoto.row.id)">{{userphoto.row.realname}}</span>
                </div>
              </el-table-column>
              <el-table-column
              class="tableposition"
              ...
              <el-table-column align="center" label="操作" width="180" class="tableoperation">
      ...
      <div class="mssage" v-show="ismsg">
        <div class="bgmsg">
          <img :src="eventUser.logo_url?eventUser.logo_url:require('assets/images/avatar_100.png')" alt="">
          <span></span>
          <div class="centenmsg">
            <p>{{this.msgname}}</p>
