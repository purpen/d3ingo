        ...
        <el-row :gutter="20">
          <el-col :xs="24" :sm="8" :md="8" :lg="8">
            <el-form-item label="客户" prop="company_name">
              <el-input v-model="form.company_name" placeholder="请填写公司名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
              ...
              <el-row :gutter="10">
                ...
                <el-col :xs="24" :sm="7" :md="7" :lg="7">
                  <el-form-item
                    ...
                    <el-input v-model="form.plan_format[index].content" placeholder="请填写工作内容" size="small"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="7" :md="7" :lg="7">
                ...
                <el-col :xs="24" :sm="3" :md="3" :lg="3">
                  <el-form-item
                    ...
                    :rules="[{
                    required: true, type: 'number',  message: '请填写正确数字', trigger: 'blur'},
                ...
                <el-col :xs="24" :sm="4" :md="4" :lg="4">
                  <el-form-item
                    ...
                    :rules="[{
                    required: true, type: 'number', message: '请填写正确的格式', trigger: 'blur'},
                    {min: 1, type: 'number', message: '请填写正确天数', trigger: 'blur'}]">
                    <el-input type="number" min="1" v-model.number="form.plan_format[index].price" @blur="statPrice" placeholder="请填写费用" size="small">
