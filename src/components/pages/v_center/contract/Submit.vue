        ...
        <div class="right-content">
          <div class="content-box">
            ...
            <el-form :model="form" :rules="ruleForm" ref="ruleForm">
              ...
              <p class="mar-b-10">本合同设计费用总额为人民币<span class="bottom-border" type="text" disabled>{{form.total}}</span> 元，丙方作为平台收取全部项目费的<span class="bottom-border" type="text" disabled v-html="form.commission_rate"></span>%，也就是人民币<span class="bottom-border" type="text" disabled>{{form.commission}}</span>元作为佣金。</p>
