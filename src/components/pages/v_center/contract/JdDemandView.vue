      ...
      <el-col :span="24">
        <div class="right-content">
          <div class="content-box">
            ...
            <p>乙方通过平台承接项目，并有权为履行本合同之目的，委托第三方设计公司履行本合同项下全部或部分权利义务；</p>
            ...
            <p>
              1、对因本合同产生的甲方选定方案，在甲方按照本合同约定完成相关的付款义务后，其全部知识产权归甲方所有。乙方保留设计者署名权。除甲方选定的方案外，落选方案的全部知识产权仍归乙方平台内设计公司所有。若甲方需要享有其他设计方案的知识产权时，需与乙方协商买断该等知识产权的相关事宜；</p>
            <p>&nbsp;</p>
