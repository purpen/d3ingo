  ...
  <div :class="['container', {'jdc': prod.name === 'jdc', 'yw': prod.name === 'yw'}]">
    ...
    <div class="login-box">
      ...
      <div class="login-content">
        ...
        <p v-if="prod.name === 'jdc'" class="authorize" @click="getJDCode">京东授权登录:<span class="fx-4"><a target="_blank" href="http://oauth2.jdcloud.com/authorize?client_id=9651541661345895&redirect_uri=http://jdyun.taihuoniao.com&response_type=code&state=matrixapp">JD</a></span></p>
      </div>
    </div>
    <div class="reg">
