  ...
  <section class="submit_one">
    <div class="pub-content" :style="{ height: calcHeight }">
      ...
      <div class="shade">
        ...
        <p class="info">
          太火鸟创新产品交易与SaaS分发平台，这里有专业、智能、高效的设计服务，针对您的设计项目需求，我们将为您匹配专业设计服务供应商，实现您的项目Idea，为您提供全方位的设计解决方案。</p>
      </div>
    </div>
    <div class="container">
      ...
      <el-row :gutter="24" type="flex" justify="center">
        <el-col :span="24">
          ...
          <div class="pub-title pub-btn about">
            ...
            <p class="des">项目成功找到设计服务供应商后，预付金将进入您为该项目向设计服务商预付的订金，成为项目订金的一部分；如果项目对接失败，预付金将被退回您的账户。</p>
          </div>
        </el-col>
      </el-row>
    </div>
