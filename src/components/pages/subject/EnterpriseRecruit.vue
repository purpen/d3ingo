          ...
          <el-col :offset="isMob ? 0 :6" :xs="24" :sm="12" :md="12" :lg="12">
            <el-card>
              ...
              <div class="el_body">
                ...
                <p>合法注册单位，完备的设计团队，专业案例或设计产品佐证的设计能力，并可从产品自身角度保证产品的快速量产能力。另外还需在太火鸟平台完成企业注册与实名认证。</p>
          ...
          <el-col v-if="false" :xs="24" :sm="12" :md="12" :lg="12">
            <el-card>
              ...
              <div class="el_body">
                <p>应用创新环节中的关键齿轮</p>
                <p class="blod">你需要具备：</p>
                <p>合法注册单位，完备的团队、设备及相当的生产能力，能够从产品生产、制造的角度保证产品的快速量产。另外还需在太火鸟平台完成企业注册与实名认证。</p>
                <p class="blod">注册与认证详情请见：</p>
                <p>服务-申请加入或帮助-常见问题</p>
              </div>
            </el-card>
...
export default {
  ...
  data() {
    return {
      calcHeight: '',
      about:
        '太火鸟是创新产品交易与SaaS分发平台，是高效线上设计交易服务平台及创新产品策源地，围绕创新产品与设计交易，为相关参与方提供包括创新产品孵化、资金保障、流量支持、运营维护等相关服务与帮助。',
      benefit: [
